      ...
      <div className="p-32" id="about">
        <div className="flex items-center justify-between gap-10">
          ...
          <div className="w-[45%] h-auto">
            ...
            <h1 className="text-green-500 text-[1.2rem] font-medium mb-2">Why you hire me for your next project?</h1>
            ...
            <div className="flex items-center mb-4">
                ...
                <h6 className="text-gray-200 text-lg font-normal tracking-wide">I have a good leader capacity,</h6>
            </div>
            <div className="flex items-center mb-10">
                <div className="w-[20px] h-[20px] flex items-center justify-center bg-green-600 rounded-sm mr-2">
                    <Check className="text-4xl text-gray-950"/>
                </div>
                <h6 className="text-gray-200 text-lg font-normal tracking-wide">I have over 1 years of experience</h6>
            </div>
