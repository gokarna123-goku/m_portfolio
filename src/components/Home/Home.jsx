...
const Home = () => {
  return (
    <>
      <div className="hero_img lg:px-32 md:px-16 sm:px-4 px-4 relative">
        ...
        <div className="lg:w-2/4 md:w-2/3 sm:w-full lg:mt-8 md:mt-5 sm:mt-1 mt-0">
          ...
          <h1 className="text-slate-100 lg:text-8xl md:text-6xl sm:text-6xl text-5xl font-black lg:leading-[7.3rem] md:leading-[6rem] sm:leading-[4.2rem] leading-[4rem] tracking-[0.12rem] mb-8">
